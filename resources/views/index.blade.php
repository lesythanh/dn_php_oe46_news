				...
				<ul>
					<li class="active menu-item-has-children">
						...
						<ul class="tg-dropdown-menu">
							<li class="active"><a href="{{route('index')}}">home1</a></li>
						</ul>
					</li>
					...
					<li class="menu-item-has-children">
						...
						<ul class="tg-dropdown-menu">
							<li><a href="{{route('matchresult')}}">match result</a></li>
							<li><a href="{{route('detail')}}">match result detail</a></li>
						</ul>
					</li>
				</ul>
			</div>
				...
				<ul>
					...
					<li class="menu-item-has-children">
						...
						<ul>
							...
							<li><a href="{{route('posts.index')}}">blog list</a></li>
								...
								<div class="tg-colhalf">
                                    <ul>
                                        <li class="active">
                                            <a href="#">Main</a>
                                            <ul class="tg-dropdown-menu">
                                                <li class="active"><a href="{{route('home')}}">home1</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">team</a>
                                            <ul class="tg-dropdown-menu">
                                                <li><a href="{{route('tem')}}">playergrid-v1</a></li>
                                            </ul>
                                        </li>
                                        <li>
                                            <a href="#">Match Results</a>
